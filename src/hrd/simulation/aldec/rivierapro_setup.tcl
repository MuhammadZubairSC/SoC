...
alias com {
  ...
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/Embed_mm_interconnect_0_avalon_st_adapter_007_error_adapter_0.sv"   -work error_adapter_0                    
  ...
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Embed_mm_interconnect_0_avalon_st_adapter_007.v"                    -work avalon_st_adapter_007              
  ...
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/Embed_mm_interconnect_0_rsp_demux_004.sv"                           -work rsp_demux_004                      
